...
{
    //Use static - do not need to create a new instance DbInitializer to make use of SeedData method. Use static method when not usin arguments
    // then used by DBInitialzer. So if DbInItializer had arguments to be used in SeeData - could not use static
    public static async Task SeedData(AppDbContext context)
    {
        ...
        //At ths stage it's just tracking and storingthe command
